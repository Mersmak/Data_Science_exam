...
# All the data are in the data_import chunks. Remember to run everything top - down, and install all packages prior to running the code. All the data is downloaded from the web, so make sure you have internett connection, working with this rmd file. 
# for questions about running the data, please contact oerjan.myrland@gmail.com 
