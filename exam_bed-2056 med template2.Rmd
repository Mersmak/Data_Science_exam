...
ggplot() + 
  ...
  theme_classic() + 
  scale_colour_manual(name="Year",values=c("2015"="purple", "2016"="blue", "2017"="grey", "2018" = "cyan"))
...
ggplot() +
    geom_line(data = mean_overdoses, aes(x = years, y =mean_overdoses, group = 1), colour = "red" ) +  xlab("Year") + ylab("Average deaths") 
