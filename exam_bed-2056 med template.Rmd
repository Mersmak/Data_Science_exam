...
<h1> Let's take a look at the total number of deaths by drugs scaled for 10 000 inhabitants per state </h1> 
...
geom_bar(stat="identity", width=.7, position = "dodge") + 
  ...
  labs(
        ...
        x = "State",
        y = "Deaths")  + theme (panel.background = element_blank())
```
...
<h2> Average amount of drug overdoses per month 2015-2018 </h2>
...
ggplot() +
  ...
  guides(fill=TRUE)+
  #labs(
        #title = "Average amount of drug overdoses per month 2015-2018")+
        #x = "State",
       # y = "Deaths")
  theme_classic()
...
<p>
The years are displayed with the following colors:</p>
<p>-2015 is Red</p>
<p>-2016 is Blue</p>
<p>-2017 is Orange</p>
<p>-2018 is Green</p>
...
ggplot() +
    geom_line(data = mean_overdoses, aes(x = years, y =mean_overdoses, group = 1), colour = "red" ) +  xlab("Year") + ylab("Deaths") + theme_classic()

ggplot() +
    geom_line(data = mean_deaths, aes(x = years, y =mean_deaths, group = 1), colour = "blue" ) +  xlab("Year") + ylab("Deaths") +
  theme_classic()

#Doing a correlation test
cortest <- cor.test(mean_overdoses$mean_overdoses,mean_deaths$mean_deaths)
